...
class MinesweeperAgent(object):
    def __init__(self, **kwargs):
        ...
        model_name = "/workspace/minesweeper_checkpoints/merged_latest"  # ← ONLY THIS LINE
    ...
    def generate_response(
        ...
        # ✅ CHANGE 3: Add temperature and top_p to match training
        generated_ids = self.model.generate(
            **model_inputs,
            max_new_tokens=kwargs.get("max_new_tokens", 96),  # ← Changed from 128 to 96
